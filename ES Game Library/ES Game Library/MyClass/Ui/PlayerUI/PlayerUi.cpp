...
void PlayerUi::Draw2D()
{
	...
	SpriteBatch.Draw(*score_font, banner_position + Vector3((10 * 0.5), -30, 0), RectWH(_i_player_data->GetParameterLevel(tag) * 64, 0, 64, 64), (DWORD)Color_White, Vector3(0, 0, 0), Vector3(0, 0, 0), 0.5f);
}
